...
CREATE TABLE `player_wheel_slots` (
  `player_id` int NOT NULL,
  `slot` tinyint UNSIGNED NOT NULL,
...
--
-- Table structure for table `player_wheel_gems`
--

CREATE TABLE `player_wheel_gems` (
  `player_id` int NOT NULL,
...
--
-- Table structure for table `player_wheel_grades`
--

CREATE TABLE `player_wheel_grades` (
  `player_id` int NOT NULL,
...
--
-- Table structure for table `player_wheel_scrolls`
--

CREATE TABLE `player_wheel_scrolls` (
  `player_id` int NOT NULL,
