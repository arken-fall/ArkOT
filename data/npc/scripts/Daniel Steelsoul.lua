...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "trolls") and npcHandler.topic[playerId] == 4 then
		...
		npcHandler.topic[playerId] = 0
	elseif msgcontains(msg, "goblins") and npcHandler.topic[playerId] == 4 then
	...
	elseif msgcontains(msg, "no") then
		...
		elseif npcHandler.topic[playerId] == 3 then
			...
			npcHandler.topic[playerId] = 2
		elseif npcHandler.topic[playerId] == 5 and player:getLevel() >= 30 then
		...
		elseif npcHandler.topic[playerId] == 6 and player:getLevel() < 40 then
			if player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.RotwormTask) < 0 or player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.RotwormTask) == 1 then
