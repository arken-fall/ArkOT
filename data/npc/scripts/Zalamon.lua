...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		...
		elseif player:getStorageValue(Storage.Quest.U8_6.WrathOfTheEmperor.Questline) == 6 then
			npcHandler:say({
				...
				"Zze gardenzz are plagued by a cid. Zze former keeper of zzizz garden became an abomination of madnezz zzat needzz to be zztopped. ... ",
	...
	elseif msgcontains(msg, "poison") or msgcontains(msg, "poizzon") then
		if player:getStorageValue(Storage.Quest.U8_54.ChildrenOfTheRevolution.Questline) == 9 then
			npcHandler:say("Zze emperor of zze dragonzz hazz tranzzformed himzzelf into an undead cid to lazzt for all eternity, to cheat deazz. Hizz corruption flowzz to zzozze he bound, and from zzem to zzozze zzey bound, and from zzem into zze land.", cid)
			npcHandler.topic[playerId] = 0
		end
		-- CHILDREN OF REVOLUTION QUEST
