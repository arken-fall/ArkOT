...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "chalice") and player:getStorageValue(Storage.Quest.U11_02.ForgottenKnowledge.Chalice) == 1 then
		npcHandler:say("Finally. That's what I... oh wait, you're still talking to me - you will blow my cover! What do you want? Oh wait, did my {daughter} send you? It has been some time now, indeed.", cid)
		npcHandler.topic[playerId] = 1
	end

	if msgcontains(msg, "daughter") and npcHandler.topic[playerId] == 1 then
		npcHandler:say({
	...
	if msgcontains(msg, "story") and npcHandler.topic[playerId] == 2 then
		npcHandler:say({
	...
	if msgcontains(msg, "disguised") and npcHandler.topic[playerId] == 3 then
		npcHandler:say({
	...
	if msgcontains(msg, "thirsty") and npcHandler.topic[playerId] == 4 then
		npcHandler:say({
	...
	if msgcontains(msg, "learned") and npcHandler.topic[playerId] == 5 then
		npcHandler:say({
