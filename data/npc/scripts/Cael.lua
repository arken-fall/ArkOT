...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "tome") or msgcontains(msg, "knowledge") then
		...
		if player:getStorageValue(TheNewFrontier.Mission08) == 2 then
			...
			elseif player:getStorageValue(TheNewFrontier.TomeofKnowledge) >= 1 and player:getStorageValue(TheNewFrontier.TomeofKnowledge) <= 5 then --tome2 - tome6
				...
				npcHandler.topic[playerId] = player:getStorageValue(TheNewFrontier.TomeofKnowledge + 1)
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[playerId] >= 1 and npcHandler.topic[playerId] <= 13 then
		if player:removeItem(10217, 1) then --remove tome
			...
			elseif npcHandler.topic[playerId] >= 2 and npcHandler.topic[playerId] <= 12 then --tome2 - tome12
				...
				npcHandler.topic[playerId] = player:getStorageValue(TheNewFrontier.TomeofKnowledge + 20)
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[playerId] == 65 then
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[playerId] == 66 then
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[playerId] >= 60 and npcHandler.topic[playerId] <= 61 then
