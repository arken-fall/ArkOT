...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") or msgcontains(msg, "sceptre") then
		if player:getStorageValue(Storage.Quest.U8_6.WrathOfTheEmperor.Questline) == 10 then
			if player:getPosition().z == 12 and player:getStorageValue(Storage.Quest.U8_6.WrathOfTheEmperor.GhostOfAPriest01) < 1 and npcHandler.topic[playerId] ~= 1 then
				npcHandler:say({
	...
	elseif msgcontains(msg, "no") and npcHandler.topic[playerId] then
