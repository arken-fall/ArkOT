...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[playerId] == 1 and player:removeItem(8758, 1) then
			...
			npcHandler.topic[playerId] = 0
		elseif npcHandler.topic[playerId] == 2 and player:removeItem(8760, 1) then
			...
			player:setStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.SearoutesAroundYalahar.TownsCounter, player:getStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.SearoutesAroundYalahar.TownsCounter) + 1)
			npcHandler.topic[playerId] = 0
		elseif npcHandler.topic[playerId] == 3 and player:removeItem(8759, 1) then
			...
			player:setStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.SearoutesAroundYalahar.TownsCounter, player:getStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.SearoutesAroundYalahar.TownsCounter) + 1)
			npcHandler.topic[playerId] = 0
		elseif npcHandler.topic[playerId] == 4 and player:removeItem(8761, 1) then
			...
			player:setStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.SearoutesAroundYalahar.TownsCounter, player:getStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.SearoutesAroundYalahar.TownsCounter) + 1)
			npcHandler.topic[playerId] = 0
		elseif npcHandler.topic[playerId] == 5 and player:removeItem(3044, 1) then
			...
			player:setStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.SearoutesAroundYalahar.TownsCounter, player:getStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.SearoutesAroundYalahar.TownsCounter) + 1)
			npcHandler.topic[playerId] = 0
		elseif npcHandler.topic[playerId] == 6 and player:removeItem(8762, 1) then
			...
			player:setStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.SearoutesAroundYalahar.TownsCounter, player:getStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.SearoutesAroundYalahar.TownsCounter) + 1)
			npcHandler.topic[playerId] = 0
		elseif npcHandler.topic[playerId] == 7 and player:removeItem(5552, 1, 13) then
			...
			player:setStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.SearoutesAroundYalahar.TownsCounter, player:getStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.SearoutesAroundYalahar.TownsCounter) + 1)
			npcHandler.topic[playerId] = 0
		elseif npcHandler.topic[playerId] == 8 and player:removeItem(8763, 1) then
