...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if player:getStorageValue(Storage.Quest.U8_2.TheInquisitionQuest.Questline) == 6 then
			...
			elseif player:getStorageValue(Storage.Quest.U8_2.TheInquisitionQuest.StorkusVampiredust) < 20 then
				npcHandler:say("So far ye've brought me " .. math.max(player:getStorageValue(Storage.Quest.U8_2.TheInquisitionQuest.StorkusVampiredust), 0) .. " of 20 {vampire dusts}. Do ye' have any more with ye'? ", cid)
	...
	elseif msgcontains(msg, "vampire lord token") and player:getStorageValue(Storage.Quest.U8_2.TheInquisitionQuest.Questline) >= 11 then
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[playerId] == 1 then
			...
			npcHandler:say("Ye've brought me " .. count .. " vampire dusts. " .. (remaining == 0 and "Ask me for a {mission} to continue your quest." or ("Ye' need to bring " .. remaining .. " more.")), cid)
			npcHandler.topic[playerId] = 0
