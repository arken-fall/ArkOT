...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "addon") and player:getStorageValue(Storage.Quest.U7_8.PirateOutfits.PirateBaseOutfit) == 1 then
	...
	elseif npcHandler.topic[playerId] == 2 and msgcontains(msg, "task") then
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[playerId] == 5 and player:getStorageValue(Storage.Quest.U7_8.PirateOutfits.PirateHatAddon) == -1 then
			if player:getItemCount(6101) > 0 and player:getItemCount(6102) > 0 and player:getItemCount(6100) > 0 and player:getItemCount(6099) > 0 then
				if player:removeItem(6101, 1) and player:removeItem(6102, 1) and player:removeItem(6100, 1) and player:removeItem(6099, 1) then
					npcHandler:say("INCREDIBLE! You have found all four of them! |PLAYERNAME|, you have my respect. You more than deserve this hat. There you go.", cid)
