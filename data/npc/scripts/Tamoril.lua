...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "rumours") and npcHandler.topic[playerId] == 1 then
	...
	elseif msgcontains(msg, "descendants") and npcHandler.topic[playerId] == 2 then
	...
	elseif msgcontains(msg, "draconic incitements") and npcHandler.topic[playerId] == 3 then
