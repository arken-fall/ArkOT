...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "furniture") then
		if player:getStorageValue(Storage.Quest.U8_7.JackFutureQuest.QuestLine) == 3 then
			npcHandler:say("What have you done? What are all these pieces of furniture doing here? Those are ugly at best and - hey! Stop! Leave the wallpaper alone! Alright, alright! Just tell me, why are you doing this? Who's behind all this?", cid)
	...
	elseif msgcontains(msg, "yes") then
		...
		if player:getStorageValue(Storage.Quest.U8_7.JackFutureQuest.QuestLine) == 10 then
			...
			elseif npcHandler.topic[playerId] == 6 then
				npcHandler:say("Yeah, yeah... so what are you still doing here? I guess I... will have to seek out this Spectulus now, see what he has to say. There is nothing left for me in this place.", cid)
	...
	elseif msgcontains(msg, "hobbies") or msgcontains(msg, "hobby") then
		...
		elseif player:getStorageValue(Storage.Quest.U8_7.JackFutureQuest.QuestLine) == 8 then
			npcHandler:say("I... was... sculpting sulky sculptures. For all my life. Until you came in here and DESTROYED MY MASTERPIECE. Go away. I don't like you.", cid)
			npcHandler.topic[playerId] = 0
		end
	end
	return true
