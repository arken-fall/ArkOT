...
local function greetCallback(cid)
	...
	if Player(cid):getStorageValue(Storage.Quest.U7_6.TheApeCity.Questline) < 12 then
...
local function onTradeRequest(cid)
	if Player(cid):getStorageValue(Storage.Quest.U7_6.TheApeCity.Questline) < 18 then
		return false
	end
