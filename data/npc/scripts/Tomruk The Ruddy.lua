...
local function creatureSayCallback(cid, type, msg)
	...
	if (msgcontains(msg, "scroll") or msgcontains(msg, "mission")) and player:getStorageValue(Storage.Quest.U10_10.TheGravediggerOfDrefia.Mission35) == 1 and player:getStorageValue(Storage.Quest.U10_10.TheGravediggerOfDrefia.Mission36) < 1 then
		npcHandler:say({
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[playerId] == 1 and player:getStorageValue(Storage.Quest.U10_10.TheGravediggerOfDrefia.Mission35) == 1 then
		npcHandler:say({
	...
	elseif (msgcontains(msg, "scroll") or msgcontains(msg, "mission") or msgcontains(msg, "blood")) and player:getStorageValue(Storage.Quest.U10_10.TheGravediggerOfDrefia.Mission37) == 1 and player:getStorageValue(Storage.Quest.U10_10.TheGravediggerOfDrefia.Mission38) < 1 then
		npcHandler:say("Hello hello! Did you bring those blood samples?", cid)
		npcHandler.topic[playerId] = 2
	elseif msgcontains(msg, "yes") and npcHandler.topic[playerId] == 2 and player:getStorageValue(Storage.Quest.U10_10.TheGravediggerOfDrefia.Mission37) == 1 then
	...
	elseif (msgcontains(msg, "scroll") or msgcontains(msg, "mission")) and player:getStorageValue(Storage.Quest.U10_10.TheGravediggerOfDrefia.Mission40) == 1 and player:getStorageValue(Storage.Quest.U10_10.TheGravediggerOfDrefia.Mission41) < 1 then
		npcHandler:say("Hello hello! Did Hello hello! Well now, painted all those blood pagodas properly?", cid)
		npcHandler.topic[playerId] = 3
	elseif msgcontains(msg, "yes") and npcHandler.topic[playerId] == 3 and player:getStorageValue(Storage.Quest.U10_10.TheGravediggerOfDrefia.Mission40) == 1 then
		npcHandler:say({
		...
		npcHandler.topic[playerId] = 0
	elseif (msgcontains(msg, "scroll") or msgcontains(msg, "mission")) and player:getStorageValue(Storage.Quest.U10_10.TheGravediggerOfDrefia.Mission41) == 1 and player:getStorageValue(Storage.Quest.U10_10.TheGravediggerOfDrefia.Mission42) < 1 then
		npcHandler:say("Hello hell- oh, you've come for the scroll, haven't you?", cid)
		npcHandler.topic[playerId] = 4
	elseif msgcontains(msg, "yes") and npcHandler.topic[playerId] == 4 and player:getStorageValue(Storage.Quest.U10_10.TheGravediggerOfDrefia.Mission41) == 1 then
