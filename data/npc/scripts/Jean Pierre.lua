...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[playerId] == 5 then
			if canCookToday(player, Storage.Quest.U8_5.HotCuisineQuest.LastInteractionDate2) then
				...
				npcHandler:say("It seems you have already cooked this dish this year. Please come back next year in August.", cid)
				npcHandler.topic[playerId] = 0
			end
	...
	elseif msgcontains(msg, "rotworm stew") then
		if npcHandler.topic[playerId] == 4 or player:getStorageValue(Storage.Quest.U8_5.HotCuisineQuest.QuestStart) >= 1 then
	...
	elseif msgcontains(msg, "hydra tongue salad") then
		if npcHandler.topic[playerId] == 6 or player:getStorageValue(Storage.Quest.U8_5.HotCuisineQuest.QuestStart) >= 1 then
	...
	elseif msgcontains(msg, "roasted dragon wings") then
		if npcHandler.topic[playerId] == 8 or player:getStorageValue(Storage.Quest.U8_5.HotCuisineQuest.QuestStart) >= 1 then
	...
	elseif msgcontains(msg, "tropical fried terrorbird") then
		if npcHandler.topic[playerId] == 10 or player:getStorageValue(Storage.Quest.U8_5.HotCuisineQuest.QuestStart) >= 1 then
	...
	elseif msgcontains(msg, "banana chocolate shake") then
		if npcHandler.topic[playerId] == 12 or player:getStorageValue(Storage.Quest.U8_5.HotCuisineQuest.QuestStart) >= 1 then
	...
	elseif msgcontains(msg, "veggie casserole") then
		if npcHandler.topic[playerId] == 14 or player:getStorageValue(Storage.Quest.U8_5.HotCuisineQuest.QuestStart) >= 1 then
	...
	elseif msgcontains(msg, "filled") or msgcontains(msg, "jalapeño") or msgcontains(msg, "peppers") then
		if npcHandler.topic[playerId] == 16 or player:getStorageValue(Storage.Quest.U8_5.HotCuisineQuest.QuestStart) >= 1 then
	...
	elseif msgcontains(msg, "blessed steak") then
		if npcHandler.topic[playerId] == 18 or player:getStorageValue(Storage.Quest.U8_5.HotCuisineQuest.QuestStart) >= 1 then
	...
	elseif msgcontains(msg, "northern fishburger") then
		if npcHandler.topic[playerId] == 20 or player:getStorageValue(Storage.Quest.U8_5.HotCuisineQuest.QuestStart) >= 1 then
	...
	elseif msgcontains(msg, "carrot cake") then
		if npcHandler.topic[playerId] == 22 or player:getStorageValue(Storage.Quest.U8_5.HotCuisineQuest.QuestStart) >= 1 then
	...
	elseif msgcontains(msg, "coconut shrimp bake") then
		if npcHandler.topic[playerId] == 24 or player:getStorageValue(Storage.Quest.U8_5.HotCuisineQuest.QuestStart) >= 1 then
	...
	elseif msgcontains(msg, "blackjack") then
		if npcHandler.topic[playerId] == 26 or player:getStorageValue(Storage.Quest.U8_5.HotCuisineQuest.QuestStart) >= 1 then
	...
	elseif msgcontains(msg, "demonic candy ball") then
		if npcHandler.topic[playerId] == 28 or player:getStorageValue(Storage.Quest.U8_5.HotCuisineQuest.QuestStart) >= 1 then
	...
	elseif msgcontains(msg, "sweet mangonaise elixir") then
		if npcHandler.topic[playerId] == 30 or player:getStorageValue(Storage.Quest.U8_5.HotCuisineQuest.QuestStart) >= 1 then
