...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "reward") and player:getStorageValue(Storage.Quest.U11_02.TheFirstDragon.Feathers) == 1 then
		npcHandler:say({
	...
	elseif msgcontains(msg, "fight") then
		...
		npcHandler.topic[playerId] = 0
	elseif msgcontains(msg, "retirement") then
		npcHandler:say({
		...
		npcHandler.topic[playerId] = 0
	elseif msgcontains(msg, "memoirs") then
		npcHandler:say({
		...
		npcHandler.topic[playerId] = 0
	elseif msgcontains(msg, "hassle") then
		npcHandler:say({
	...
	elseif msgcontains(msg, "worthy") then
		...
		npcHandler.topic[playerId] = 0
	elseif msgcontains(msg, "weaknesses") then
		npcHandler:say({
		...
		npcHandler.topic[playerId] = 0
	elseif msgcontains(msg, "mists") then
		npcHandler:say({
		...
		npcHandler.topic[playerId] = 0
	elseif msgcontains(msg, "world") then
		npcHandler:say({
		...
		npcHandler.topic[playerId] = 0
	elseif msgcontains(msg, "books") then
		npcHandler:say({
		...
		npcHandler.topic[playerId] = 0
	elseif msgcontains(msg, "invention") then
		npcHandler:say({
		...
		npcHandler.topic[playerId] = 0
	elseif msgcontains(msg, "adapt") then
		npcHandler:say({
		...
		npcHandler.topic[playerId] = 0
	elseif msgcontains(msg, "finer") then
		npcHandler:say({
