...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "job") and not player:getStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.Questline) == 54 then
	...
	elseif msgcontains(msg, "mission") then
		...
		elseif player:getStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.Questline) == 32 and player:getStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.TamerinStatus) == 2 then
			npcHandler:say("Rumours travel fast in Yalahar. So the Yalahari will soon have some new toys at their disposal. I strongly doubt this has any positive effect.", cid)
			npcHandler.topic[playerId] = 0
		...
		elseif player:getStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.Questline) == 46 and player:getStorageValue(Storage.Quest.U8_4.InServiceOfYalahar.MatrixState) == 1 then
			npcHandler:say("You can be proud of your decision, my friend.", cid)
			npcHandler.topic[playerId] = 0
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[playerId] == 5 then
			...
			npcHandler:say("You have no idea how much I hoped to hear that, my friend! But I have an urgent mission for you!", cid)
			npcHandler.topic[playerId] = 0
