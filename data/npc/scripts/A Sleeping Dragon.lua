...
local function greetCallback(cid)
	...
	if Player(cid):getStorageValue(Storage.Quest.U8_6.WrathOfTheEmperor.Questline) == 27 then
...
local function creatureSayCallback(cid, type, msg)
	...
	if player:getStorageValue(Storage.Quest.U8_6.WrathOfTheEmperor.Questline) == 27 then
		if (msg == "SOLOSARASATIQUARIUM") and player:getStorageValue(Storage.Quest.U8_6.WrathOfTheEmperor.InterdimensionalPotion) == 1 then
			npcHandler:say({
		...
		elseif msg:lower() == "help" and npcHandler.topic[playerId] > 0 and npcHandler.topic[playerId] < 34 then
		...
		elseif msg:lower() == "take stand" and npcHandler.topic[playerId] == 5 then
		...
		elseif msg:lower() == "east" and npcHandler.topic[playerId] == 6 then
		...
		elseif msg:lower() == "take model" and npcHandler.topic[playerId] == 7 then
		...
		elseif msg:lower() == "take rubies" and npcHandler.topic[playerId] == 12 then
			npcHandler:say("You take a rather large ruby out of a pile before you. ", cid)
			npcHandler.topic[playerId] = 13
		elseif msg:lower() == "north" and npcHandler.topic[playerId] == 13 then
		...
		elseif msg:lower() == "use attachment" and npcHandler.topic[playerId] == 14 then
		...
		elseif msg:lower() == "take mirror" and npcHandler.topic[playerId] == 15 then
			npcHandler:say({
		...
		elseif msg:lower() == "north" and npcHandler.topic[playerId] == 16 then
		...
		elseif msg:lower() == "use model" and npcHandler.topic[playerId] == 17 then
			npcHandler:say({
		...
		elseif msg:lower() == "south" and npcHandler.topic[playerId] == 18 then
		...
		elseif msg:lower() == "use ruby" and npcHandler.topic[playerId] == 29 then
		...
		elseif msg:lower() == "use sapphire" and npcHandler.topic[playerId] == 30 then
		...
		elseif msg:lower() == "use emerald" and npcHandler.topic[playerId] == 31 then
		...
		elseif msg:lower() == "use mirror" and npcHandler.topic[playerId] == 32 then
			npcHandler:say({
				...
				"The hand seems to have grown into a fist. In the distance you can now see a blurry scheme of a cid too large for your eyes to get a sharper view of its head. ...",
				"Blending the rays, the mirror directs pure white light directly towards the part where you assume the face of the cid. ...",
	...
	elseif player:getStorageValue(Storage.Quest.U8_6.WrathOfTheEmperor.Questline) == 28 then
		...
		elseif msgcontains(msg, "yes") and npcHandler.topic[playerId] == 41 then
			npcHandler:say({
