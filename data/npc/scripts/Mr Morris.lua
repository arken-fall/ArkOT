...
local voices = {
	...
	{text = '<sigh> The Adventurers\' Guild really should have equipped me with more man power. Who\'s to keep all those monsters in check?'},
...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "herbs") then
		if player:getStorageValue(Storage.Quest.U10_55.Dawnport.TheRareHerb) < 1 then
			npcHandler:say(
				...
				Would you get some fresh herbs?", cid
			)
	...
	elseif msgcontains(msg, "goblins") then
