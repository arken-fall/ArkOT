...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "goshnar") and npcHandler.topic[playerId] == 2 then
		npcHandler:say(
			"HOHO! You have learned your lesson well. \z
			Question number two then: Who or what is the feared Hugo?", cid
		)
		npcHandler.topic[playerId] = 3
	elseif msgcontains(msg, "demonbunny") and npcHandler.topic[playerId] == 3 then
	...
	elseif msgcontains(msg, "tha'kull") and npcHandler.topic[playerId] == 4 then
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[playerId] == 6 then
		npcHandler:say("As you wish, foolish one! Here is my first question: It's lighter then a feather but no living cid can hold it for ten minutes?", cid)
		npcHandler.topic[playerId] = 7
	elseif msgcontains(msg, "breath") and npcHandler.topic[playerId] == 7 then
		npcHandler:say("That was an easy one. Let's try the second: If you name it, you break it.", cid)
		npcHandler.topic[playerId] = 8
	elseif msgcontains(msg, "silence") and npcHandler.topic[playerId] == 8 then
		npcHandler:say(
	...
	elseif msgcontains(msg, "old") and npcHandler.topic[playerId] == 9 then
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[playerId] == 10 then
		npcHandler:say("GOOD! So I will get you at last. Answer this: What is your favourite colour?", cid)
		npcHandler.topic[playerId] = 11
	elseif msgcontains(msg, "green") and npcHandler.topic[playerId] == 11 then
	...
	elseif msgcontains(msg, "none") and npcHandler.topic[playerId] == 12 then
		npcHandler:say(
