...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "kiss") and npcHandler.topic[playerId] == 7 then
	...
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[playerId] == 9 then
			npcHandler:say("Listen... there are no blooming flowers down here and the only smell present is that of death and decay. I wish that I could breathe the lovely smell of beautiful flowers just one more time, especially those which elves cultivate. Could you please bring me 50 holy orchids?", cid)
