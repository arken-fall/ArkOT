	...
	if msgcontains(msg, "mission") then
		...
		elseif player:getStorageValue(Storage.Quest.U8_6.WrathOfTheEmperor.Questline) == 26 then
			npcHandler:say({
				...
				"Dizabling ze cryztalz will probably alert ze emperor. It will likely be too late for him to intervene in perzon but a cid of hiz power might have ozer wayz to intervene. ...",
