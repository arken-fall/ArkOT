	...
	elseif msgcontains(msg, "result") then
		if npcHandler.topic[playerId] == 33 then
			if player:getStorageValue(Storage.Quest.U9_60.BigfootsBurden.Test) < 100 then
				...
				npcHandler:say("You have passed the test with " .. player:getStorageValue(Storage.Quest.U9_60.BigfootsBurden.Test) .. " of 112 possible points. Congratulations. You are ready to proceed with the more physical parts of your examination! Go and talk to Gnomespector about it.", cid)
