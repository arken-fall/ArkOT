...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "temple") then
		npcHandler:say("Well, I hope you like it here. We tried to rebuild in the {Shaper}'s will. I am a bit preoccupied at the moment because of the absence of my {father}. I may not be the best of help currently, sorry.", cid)
		npcHandler.topic[playerId] = 1
	elseif msgcontains(msg, "mission") then
		npcHandler:say("Besides my various {duties} in the temple, I also take care of visitors. Well, I would but right now I can't get my mind of how my {father}'s doing. I am sorry.", cid)
		npcHandler.topic[playerId] = 1
	elseif msgcontains(msg, "imbuing") or msgcontains(msg, "imbuements") then
		npcHandler:say({
	...
	elseif msgcontains(msg, "father") and npcHandler.topic[playerId] == 1 then
	...
	elseif msgcontains(msg, "no") then
		npcHandler:say("Oh nevermind, I am sorry I asked you for this.", cid)
		npcHandler.topic[playerId] = 0
	end
