...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "mission") or msgcontains(msg, "report") then
		...
		elseif player:getStorageValue(Storage.Quest.U8_2.TheInquisitionQuest.Questline) == 4 then
			npcHandler:say("Your current mission is to destroy the witches' brew with the vial of holy water and to steal their grimoire.", cid)
			npcHandler.topic[playerId] = 0
		...
		elseif player:getStorageValue(Storage.Quest.U8_2.TheInquisitionQuest.Questline) == 16 then
			npcHandler:say("Talk to me about your {outfit} anytime from now on. Afterwards, let's talk about the next mission that's awaiting you.", cid)
			npcHandler.topic[playerId] = 0
		...
		elseif player:getStorageValue(Storage.Quest.U8_2.TheInquisitionQuest.Questline) == 18 then
			npcHandler:say("Your current mission is to take revenge and to kill the demon Ungreez. You'll find him in the depths of Edron.", cid)
			npcHandler.topic[playerId] = 0
		...
		elseif player:getStorageValue(Storage.Quest.U8_2.TheInquisitionQuest.Questline) == 23 then
			npcHandler:say("Don't forget to ask me about your {outfit} to receive the final addon as demon hunter.", cid)
			npcHandler.topic[playerId] = 0
		end
