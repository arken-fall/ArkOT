...
local function creatureSayCallback(cid, type, msg)
	...
	if player:getStorageValue(Storage.Quest.U12_00.TheDreamCourts.Main.Questline) < 1 then
		...
		elseif msgcontains(msg, "help") and npcHandler.topic[playerId] == 2 then
		...
		elseif msgcontains(msg, "threat") and npcHandler.topic[playerId] == 3 then
			npcHandler:say({
		...
		elseif msgcontains(msg, "courts") and npcHandler.topic[playerId] == 4 then
		...
		elseif msgcontains(msg, "entrances") and npcHandler.topic[playerId] == 5 then
