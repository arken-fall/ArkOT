...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "warrior's sword") then
		...
		elseif player:getStorageValue(Storage.Quest.U7_8.WarriorOutfits.WarriorSwordAddon) == 1 and npcHandler.topic[playerId] == 1 then
	...
	elseif msgcontains(msg, "knight's sword") then
		...
		elseif player:getStorageValue(Storage.Quest.U7_8.KnightOutfits.AddonSword) == 1 and npcHandler.topic[playerId] == 1 then
