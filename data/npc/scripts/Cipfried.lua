...
keywordHandler:addKeyword({'vocation'}, StdModule.say, {npcHandler = npcHandler, text = 'There are five vocations in Tibia: {knight}, {sorcerer}, {paladin}, {druid} or {monk}. Each vocation has its unique special abilities.'})
