...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "addons") then
		...
		if player:getStorageValue(Storage.Quest.U11_02.TheFirstDragon.Feathers) == 2 and player:getStorageValue(Storage.Quest.U11_02.FestiveOutfits.Addon1) == 1 and hasMasks then
			npcHandler:say("I see you have the porcelain masks. Are you ready to exchange them for the first addon?", cid)
		...
		elseif player:getStorageValue(Storage.Quest.U11_02.TheFirstDragon.Feathers) == 2 and player:getStorageValue(Storage.Quest.U11_02.FestiveOutfits.Addon2) == 1 and hasFeathers then
			npcHandler:say("I see you have the colourful feathers. Are you ready to exchange them for the second addon?", cid)
			npcHandler.topic[playerId] = 4
		else
			npcHandler:say("You need the outfit and 3 porcelain masks or 50 colored feathers to get the festive costume accessories.", cid)
			npcHandler.topic[playerId] = 0
		end
	elseif msgcontains(msg, "mask") and player:getStorageValue(Storage.Quest.U11_02.FestiveOutfits.Addon1) == 1 then
		if player:removeItem(25088, 3) then
			...
			npcHandler:say("Oh, sorry but you don't have enough porcelain masks!", cid)
			npcHandler.topic[playerId] = 0
		end
	elseif msgcontains(msg, "feather") and player:getStorageValue(Storage.Quest.U11_02.FestiveOutfits.Addon2) == 1 then
		if player:removeItem(25089, 50) then
			...
			npcHandler:say("Oh, sorry but you don't have enough colourful feathers!", cid)
			npcHandler.topic[playerId] = 0
		end
	elseif msgcontains(msg, "yes") then
		...
		elseif npcHandler.topic[playerId] == 2 then
			npcHandler:say("I provide two addons. For the first one I need you to bring me three porcelain masks. For the second addon you need fifty colourful ostrich feathers. Do you want one of these addons?", cid)
			npcHandler.topic[playerId] = 3
		elseif npcHandler.topic[playerId] == 3 then
			npcHandler:say("What do you have for me: the porcelain masks or the colourful feathers?", cid)
