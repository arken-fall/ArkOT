...
local function creatureSayCallback(cid, type, msg)
	...
	if player:getSex() == PLAYERSEX_MALE and msgcontains(msg, "outfit") then
		npcHandler:say("My turban? Eh no, you can't have it. Only oriental weapon masters may wear it after having completed a difficult task.", cid)
	elseif player:getSex() == PLAYERSEX_MALE and msgcontains(msg, "task") then
