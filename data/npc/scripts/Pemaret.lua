...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[playerId] == 1 and player:getStorageValue(Storage.Quest.U7_8.MarlinTrophy) < 1 then
	...
	if msgcontains(msg, "no") and npcHandler.topic[playerId] == 1 then
