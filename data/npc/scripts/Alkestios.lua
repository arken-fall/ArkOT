...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		if player:getStorageValue(ThreatenedDreams.Mission01[1]) == 1 and player:getStorageValue(ThreatenedDreams.Mission01.PoacherChest) == 1 then
			npcHandler:say("Uhmn.. Maybe Ahmet in Ankrahmun can help we to fake this book.", cid)
		elseif player:getStorageValue(ThreatenedDreams.Mission01[1]) == 2 then
			npcHandler:say("The poachers are still chasing me. Please hurry and find a way to help me.", cid)
	...
	elseif msgcontains(msg, "help") and player:getStorageValue(ThreatenedDreams.Mission01[1]) < 1 then
		npcHandler:say({
