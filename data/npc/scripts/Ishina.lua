...
local function creatureSayCallback(cid, type, msg)
	...
	if player:getSex() == PLAYERSEX_FEMALE and msgcontains(msg, "outfit") and player:getStorageValue(Storage.Quest.U7_6.ExplorerSociety.TheOrcPowder) >= 34 and player:getStorageValue(Storage.Quest.U7_6.ExplorerSociety.QuestLine) >= 44 then
	...
	elseif player:getSex() == PLAYERSEX_FEMALE and msgcontains(msg, "comb") then
		if player:getStorageValue(Storage.Quest.U7_8.OrientalOutfits.FirstOrientalAddon) == 1 then
