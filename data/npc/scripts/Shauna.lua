...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "job") then
		if Player(cid):getStorageValue(Storage.Quest.U7_4.DjinnWar.EfreetFaction.Mission01) == 2 then
	...
	elseif msgcontains(msg, "prisoner") then
		if npcHandler.topic[playerId] == 2 then
			...
			Player(cid):setStorageValue(Storage.Quest.U7_4.DjinnWar.EfreetFaction.Mission01, 3)
