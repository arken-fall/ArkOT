...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "ok") then
		if npcHandler.topic[playerId] == 3 then
			npcHandler:say("Good. Thanks, man. That's one vote you got for helping us with this. If you want to redo this task just say {abandoned sewers} to repeat it.", cid)
