...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "tiara") and player:getStorageValue(Storage.Quest.U7_8.MageAndSummonerOutfits.AddonHatCloak) < 1 then
		if npcHandler.topic[playerId] ~= 100 then
			npcHandler:say("Please ask about the 'outfit' first.", cid)
		else
			...
			elseif storageValue == 11 then
				npcHandler:say("I don't have any tasks for you right now, |PLAYERNAME|. You were of great help.", cid)
			end
		end
	...
	elseif msgcontains(msg, "task") then
		...
		if taskMessage then
			npcHandler:say(taskMessage, cid)
		end
	...
	elseif npcHandler.topic[playerId] == 12 then
		if msgcontains(msg, "tiara") and player:getStorageValue(Storage.Quest.U7_8.MageAndSummonerOutfits.AddonHatCloak) == 10 then
			npcHandler:say("Go to the academy in Edron and tell Zoltan that I sent you, |PLAYERNAME|.", cid)
		end
	end
