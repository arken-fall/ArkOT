...
local function greetCallback(npc, cid, msg)
	...
	npcHandler:say("Welcome, human |PLAYERNAME|, to our humble abode.", cid)
...
local function creatureSayCallback(cid, type, msg)
	...
	elseif npcHandler.topic[playerId] == 2 then
		...
		npcHandler.topic[playerId] = 0
	elseif msgcontains(msg, "task") and player:getStorageValue(Storage.Quest.U7_4.DjinnWar.MaridFaction.Mission03) == 3 then
		...
		elseif player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.GreenDjinnTask) == 0 then
			if player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.MonsterKillCount.GreenDjinnCount) >= 500 then
				...
				npcHandler:say("Come back when you kill 500 green djinns or Efreet.", cid)
			end
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[playerId] == 3 then
		npcHandler:say("All right. May Daraman bless your hunt, human.", cid)
