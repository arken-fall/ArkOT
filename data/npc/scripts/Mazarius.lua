...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[playerId] == 2 and player:getStorageValue(Storage.Quest.U10_90.FerumbrasAscension.Access) < 1 then
	...
	elseif msgcontains(msg, "essence") or msgcontains(msg, "essences") then
