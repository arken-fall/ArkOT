local movements_prohibit_entry = ItemEvent()

function movements_prohibit_entry.onStepOn(creature, item, position, fromPosition)
...
movements_prohibit_entry:type("stepon")
