...
local spiderLairHole = ItemEvent()

function spiderLairHole.onStepOn(creature, item, position, fromPosition)
	local player = creature:getPlayer()
	if not player then
		return true
	end
...
local greasyStone = ItemEvent()

greasyStone:type("use")
...
local spiderQueenChamberHole = ItemEvent()

function spiderQueenChamberHole.onStepOn(creature, item, position, fromPosition)
	local player = creature:getPlayer()
	if not player then
		return true
	end
