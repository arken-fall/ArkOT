...
local missionGuide = ItemEvent()

function missionGuide.onStepOn(creature, item, position, fromPosition)
...
local treasureChest = ItemEvent()

treasureChest:type("use")
...
local unconsciousOrc = ItemEvent()

unconsciousOrc:type("use")
...
local poisonFlask = ItemEvent()

poisonFlask:type("use")
...
local taranturaTrap = ItemEvent()

taranturaTrap:type("use")
...
local bossLairTeleport = ItemEvent()

function bossLairTeleport.onStepOn(creature, item, position, fromPosition)
	local player = creature:getPlayer()
	if not player then
		return true
	end
...
local missionEnergyBarriers = ItemEvent()

function missionEnergyBarriers.onStepOn(creature, item, position, fromPosition)
	local player = creature:getPlayer()
	if not player then
		return true
	end
...
local missionLevers = ItemEvent()

missionLevers:type("use")
...
local enterBossRoomTeleport = ItemEvent()

function enterBossRoomTeleport.onStepOn(creature, item, position, fromPosition)
	local player = creature:getPlayer()
	if not player then
		return true
	end
...
local exitBossRoomTeleport = ItemEvent()

function exitBossRoomTeleport.onStepOn(creature, item, position, fromPosition)
	local player = creature:getPlayer()
	if not player then
		return true
	end
...
local enterTreasureRoomTeleport = ItemEvent()

function enterTreasureRoomTeleport.onStepOn(creature, item, position, fromPosition)
	local player = creature:getPlayer()
	if not player then
		return true
	end
...
local exitTreasureRoomTeleport = ItemEvent()

function exitTreasureRoomTeleport.onStepOn(creature, item, position, fromPosition)
	local player = creature:getPlayer()
	if not player then
		return true
	end
...
local orcFortressChests = ItemEvent()

orcFortressChests:type("use")
