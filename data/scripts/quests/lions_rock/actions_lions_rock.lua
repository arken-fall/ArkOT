...
local lionsRockSacrificesTest = ItemEvent()
lionsRockSacrificesTest:type("use")
...
-- Get lions mane
local lionsGetLionsMane = ItemEvent()
lionsGetLionsMane:type("use")
...
-- Get holy water
local lionsGetHolyWater = ItemEvent()
lionsGetHolyWater:type("use")
...
-- Lions rock fountain
local lionsRockFountain = ItemEvent()
lionsRockFountain:type("use")
