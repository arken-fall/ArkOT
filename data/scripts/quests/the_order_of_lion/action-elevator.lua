local elevatorBounacAction = ItemEvent()
elevatorBounacAction:type("use")
...
local elevatorBounacMoveEvent = ItemEvent()
function elevatorBounacMoveEvent.onStepOn(creature, item, position, fromPosition)
