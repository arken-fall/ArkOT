local mission9TheDeepestCatacombTeleport = ItemEvent()
...
function mission9TheDeepestCatacombTeleport.onStepOn(creature, item, position, fromPosition)
...
mission9TheDeepestCatacombTeleport:type("stepon")
