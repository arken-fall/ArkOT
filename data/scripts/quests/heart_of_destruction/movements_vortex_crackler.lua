...
local vortexCrackler = ItemEvent()

function vortexCrackler.onStepOn(creature, item, position, fromPosition)
...
vortexCrackler:type("stepon")
vortexCrackler:id(23471)
vortexCrackler:register()

vortexCrackler = ItemEvent()

function vortexCrackler.onStepOff(creature, item, position, fromPosition)
	cracklerTransform = false
	return true
end

vortexCrackler:type("stepoff")
vortexCrackler:id(23471)
vortexCrackler:register()
