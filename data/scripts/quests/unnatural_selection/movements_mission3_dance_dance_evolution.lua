...
local mission3DanceDanceEvolution = ItemEvent()

function mission3DanceDanceEvolution.onStepOn(creature, item, position, fromPosition)
...
mission3DanceDanceEvolution:type("stepon")
