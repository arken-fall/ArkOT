local movements_enter_diprath_room = ItemEvent()

function movements_enter_diprath_room.onStepOn(creature, item, position, fromPosition)
...
movements_enter_diprath_room:type("stepon")
