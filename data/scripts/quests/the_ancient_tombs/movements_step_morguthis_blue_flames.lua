...
local stepMorguthisBlueFlames = ItemEvent()

function stepMorguthisBlueFlames.onStepOn(creature, item, position, fromPosition)
...
stepMorguthisBlueFlames:type("stepon")
