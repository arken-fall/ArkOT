local movements_enter_morguthis_room = ItemEvent()

function movements_enter_morguthis_room.onStepOn(creature, item, position, fromPosition)
...
movements_enter_morguthis_room:type("stepon")
