local lowerRoshamuul20122 = ItemEvent()

function lowerRoshamuul20122.onStepOn(creature, item, position, fromPosition)
...
lowerRoshamuul20122:type("stepon")
...
local lowerRoshamuul1500 = ItemEvent()

function lowerRoshamuul1500.onStepOn(creature, item, position, fromPosition)
	local player = creature:getPlayer()
	if not player then
		return false
	end
...
lowerRoshamuul1500:type("stepon")
