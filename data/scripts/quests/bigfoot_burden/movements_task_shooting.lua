...
local taskShooting = ItemEvent()
function taskShooting.onStepOn(creature, item, position, fromPosition)
...
taskShooting = ItemEvent()
function taskShooting.onStepOff(creature, item, position, fromPosition)
