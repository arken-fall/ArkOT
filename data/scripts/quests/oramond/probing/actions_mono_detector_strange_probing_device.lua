...
local actions_mono_detector = ItemEvent()

actions_mono_detector:type("use")
...
local actions_strange_probing_device = ItemEvent()

actions_strange_probing_device:type("use")
