...
local carvingTeleportLibertyBay = ItemEvent()

function carvingTeleportLibertyBay.onStepOn(creature, item, position, fromPosition)
...
carvingTeleportLibertyBay:type("stepon")
