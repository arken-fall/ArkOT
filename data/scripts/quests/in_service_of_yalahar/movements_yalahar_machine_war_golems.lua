...
local yalaharMachineWarGolems = ItemEvent()

function yalaharMachineWarGolems.onStepOn(creature, item, position, fromPosition)
...
yalaharMachineWarGolems:type("stepon")
