...
local potions = {
	...
	[7443] = { -- bullseye potion
		...
		description = "Only paladins and monks may drink this potion.",
	...
	[7588] = { -- strong health potion
		...
		level = 50,
		flask = 7634,
		description = "Only knights, paladins and monks of level 50 or above may drink this fluid."
	},
	[7589] = { -- strong mana potion
		...
		level = 50,
		flask = 7634,
		description = "Only sorcerers, druids, paladins and monks of level 50 or above may drink this fluid."
	},
...
local potionItem = ItemEvent()

potionItem.onUse = function(player, item, fromPosition, target, toPosition, isHotkey)
	...
	elseif potion.transform then
		...
		if potion.health then
			doTargetCombat(player, target, Combat.DamageType.Healing, potion.health[1], potion.health[2])
		end
...
potionItem:id(6558)
for id = 7439, 7440 do potionItem:id(id) end
potionItem:id(7443)
for id = 7588, 7591 do potionItem:id(id) end
potionItem:id(7618)
potionItem:id(7620)
for id = 8472, 8474 do potionItem:id(id) end
potionItem:id(8704)
for id = 26029, 26031 do potionItem:id(id) end
potionItem:register()
