...
monster.bestiary = {
	...
	stars = 2,
	occurrence = 0,
	locations = "Hero Cave (Edron), Magician Tower, Dark Cathedral and Yalahar Academy of Magic in Magician Quarter and a single one on The Witches' Cliff (only accessible during a quest).",
}
