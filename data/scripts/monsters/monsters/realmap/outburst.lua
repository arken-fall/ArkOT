...
monster.description = "a outburst"
...
monster.outfit = { lookType = 876, lookHead = 79, lookBody = 57, lookLegs = 94, lookFeet = 0, lookAddons = 3 }
...
monster.summons = {
    {name = "Greed", interval = 4000, chance = 8, max = 5},
    {name = "Charger", interval = 4000, chance = 8, max = 3},
}
monster.voices = {
    interval = 2000,
    chance = 7,
    {text = "I OUTBURST!", yell = true},
}
