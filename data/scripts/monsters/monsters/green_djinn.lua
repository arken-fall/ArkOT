...
monster.bestiary = {
	...
	stars = 3,
	occurrence = 0,
	locations = "Mal'ouquah, Oasis Tomb, under the Ankrahmun Library Tomb, Serpentine Tower last floor behind the Magic Walls, Deeper Banuta, Goroma underground, Magician Quarter.",
}
