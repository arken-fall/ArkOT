...
monster.bestiary = {
	...
	stars = 1,
	occurrence = 2,
	locations = "South-east, east and north-east of Thais depending on the Horse Station World Change; one in the Gardens of Night (here, unreachable); one near Roswitha in Rathleton.",
}
