...
monster.attacks = {
	{
		...
		minDamage = 0,
		maxDamage = -100,
		condition = { type = CONDITION_POISON, interval = 4000, minDamage = 3, maxDamage = 3 },
	},
	{
		name = "combat",
		interval = 2000,
	...
	{ name = "speed", interval = 2000, chance = 10, range = 7, effect = CONST_ME_MAGIC_RED, target = false, duration = 15000, speed = -300 },
}
