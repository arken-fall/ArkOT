...
monster.loot = {
	...
	{ id = 9970, chance = 7000, maxCount = 2 },
	{ id = 7590, chance = 18830, maxCount = 2 },
	{ id = 24124, chance = 3000 },
	{ id = 2149, chance = 7430, maxCount = 2 },
	{ id = 39880, chance = 5155 },
	{ id = 39827, chance = 1500 },
	{ id = 23538, chance = 5155 },
}
...
monster.defenses = {
	...
	armor = 40,
	mitigation = 1.4,
	{ name = "speed", interval = 2000, chance = 13, effect = CONST_ME_MAGIC_RED, target = false, duration = 4000, speed = 404 },
