...
monster.loot = {
	{ id = 2148, chance = 30000, maxCount = 171 },
	{ id = 15649, chance = 15000, maxCount = 3 },
	{ id = 30499, chance = 7000 },
	{ id = 7591, chance = 7000 },
	{ id = 2789, chance = 7000 },
	{ id = 2666, chance = 12000 },
	{ id = 2152, chance = 22000, maxCount = 2 },
	{ id = 2147, chance = 7000, maxCount = 2 },
}
...
monster.attacks = {
	...
	{ name = "speed", interval = 2000, chance = 9, effect = CONST_ME_GIANTICE, target = true, duration = 7000, speed = -440 },
}
