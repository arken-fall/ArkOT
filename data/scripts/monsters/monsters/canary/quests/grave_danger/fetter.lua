...
monster.attacks = {
	{
		...
		minDamage = 0,
		maxDamage = -308,
		condition = { type = CONDITION_POISON, interval = 4000, minDamage = 300, maxDamage = 300 },
	},
...
monster.defenses = {
	...
	{ name = "speed", interval = 2000, chance = 15, effect = CONST_ME_MAGIC_RED, target = false, duration = 5000, speed = 290 },
}
