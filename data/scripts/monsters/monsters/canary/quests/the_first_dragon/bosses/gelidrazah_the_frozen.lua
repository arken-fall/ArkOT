...
monster.loot = {
	...
	{ id = 31027, chance = 80000, maxCount = 2 },
	{ id = 21696, chance = 500 },
	{ id = 21697, chance = 500 },
	{ id = 7409, chance = 1500 },
	{ id = 18412, chance = 1500 },
	{ id = 31029, chance = 100000 },
}
...
monster.attacks = {
	...
	{ name = "speed", interval = 2000, chance = 15, length = 9, spread = 3, effect = CONST_ME_ICEATTACK, target = false, duration = 10000, speed = -600 },
	{
		name = "combat",
		interval = 2000,
		chance = 15,
