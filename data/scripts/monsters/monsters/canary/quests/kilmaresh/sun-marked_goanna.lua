...
monster.loot = {
	{ id = 35419, chance = 100000 },
	{ id = 2152, chance = 100000, maxCount = 3 },
	{ id = 18437, chance = 50000, maxCount = 29 },
	{ id = 2411, chance = 50000 },
	{ id = 35479, chance = 50000 },
}
...
monster.attacks = {
	{
		...
		minDamage = 0,
		maxDamage = -350,
		condition = { type = CONDITION_POISON, interval = 4000, minDamage = 19, maxDamage = 19 },
	},
...
monster.defenses = {
	...
	armor = 84,
	mitigation = 2.6,
	{ name = "speed", interval = 2000, chance = 5, effect = CONST_ME_MAGIC_RED, target = false, duration = 5000, speed = 500 },
}
