...
monster.attacks = {
	...
	{ name = "speed", interval = 4000, chance = 20, range = 7, shootEffect = CONST_ANI_POISON, target = true, duration = 12000, speed = -350 },
	{
		name = "combat",
		interval = 2000,
		chance = 20,
	...
	{ name = "outfit", interval = 2000, chance = 1, range = 7, effect = CONST_ME_MAGIC_BLUE, target = false, duration = 3000, item = 4240 },
	{
		name = "combat",
		interval = 2000,
		chance = 10,
