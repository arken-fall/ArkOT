...
monster.attacks = {
	{
		...
		minDamage = 0,
		maxDamage = -240,
		condition = { type = CONDITION_POISON, interval = 4000, minDamage = 150, maxDamage = 150 },
	},
	{
		name = "combat",
		interval = 2000,
	...
	{ name = "speed", interval = 2000, chance = 15, length = 8, spread = 3, effect = CONST_ME_SMALLCLOUDS, target = false, duration = 15000, speed = -700 },
}
