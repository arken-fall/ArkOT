...
monster.summons = {
	{ name = "hardened usurper archer", chance = 0, interval = 600000, max = 2 },
	{ name = "hardened usurper warlock", chance = 0, interval = 600000, max = 2 },
	{ name = "hardened usurper knight", chance = 0, interval = 600000, max = 2 },
}
