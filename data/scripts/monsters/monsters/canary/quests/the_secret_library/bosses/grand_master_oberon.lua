...
monster.loot = {
	...
	{ id = 2511, chance = 30000, maxCount = 1 },
	{ id = 33681, chance = 25000, maxCount = 1 },
	{ id = 2473, chance = 23000, maxCount = 1 },
	{ id = 33587, chance = 500, maxCount = 1 },
	{ id = 33586, chance = 500, maxCount = 1 },
	{ id = 33588, chance = 500, maxCount = 1 },
	{ id = 33666, chance = 500, maxCount = 1 },
	{ id = 33581, chance = 350, maxCount = 1 },
	{ id = 33577, chance = 350, maxCount = 1 },
	{ id = 33578, chance = 350, maxCount = 1 },
	{ id = 33579, chance = 350, maxCount = 1 },
	{ id = 33580, chance = 350, maxCount = 1 },
	{ id = 48129, chance = 300, maxCount = 1 },
	{ id = 33584, chance = 200, maxCount = 1 },
	{ id = 33583, chance = 200, maxCount = 1 },
	{ id = 33582, chance = 200, maxCount = 1 },
}
...
monster.defenses = {
	defense = 60,
	armor = 82,
	{ name = "speed", interval = 1000, chance = 10, effect = CONST_ME_POFF, target = false, duration = 4000, speed = 180 },
}
