...
monster.loot = {
	{ id = 6558, chance = 50000, maxCount = 2 },
	{ id = 2671, chance = 50000, maxCount = 2 },
	{ id = 7365, chance = 35000, maxCount = 3 },
	{ id = 2145, chance = 30000, maxCount = 3 },
	{ id = 2149, chance = 30000, maxCount = 3 },
	{ id = 7762, chance = 20000, maxCount = 3 },
	{ id = 33664, chance = 2350, maxCount = 3 },
	{ id = 7632, chance = 12000, maxCount = 1 },
	{ id = 2476, chance = 7000 },
	{ id = 33663, chance = 1800 },
	{ id = 7452, chance = 3200 },
	{ id = 7413, chance = 2400 },
	{ id = 33587, chance = 200 },
	{ id = 33586, chance = 200 },
...
monster.defenses = {
	...
	{ name = "speed", interval = 1000, chance = 10, effect = CONST_ME_POFF, target = false, duration = 5000, speed = 220 },
}
