...
monster.summons = {
	{ name = "neutral deepling warrior", chance = 70, interval = 1000, max = 5 },
}
...
monster.loot = {
	{ id = 2146, chance = 2854, maxCount = 10 },
	{ id = 2148, chance = 70000, maxCount = 60 },
	{ id = 2152, chance = 80000, maxCount = 10 },
	{ id = 9971, chance = 3448, maxCount = 10 },
	{ id = 12417, chance = 2439, maxCount = 10 },
	{ id = 2145, chance = 498, maxCount = 10 },
	{ id = 2158, chance = 2500 },
	{ id = 2156, chance = 2000 },
	{ id = 33667, chance = 200 },
	{ id = 33668, chance = 200 },
	{ id = 33565, chance = 70000 },
}
