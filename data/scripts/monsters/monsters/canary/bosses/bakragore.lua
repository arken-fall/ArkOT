...
monster.summons = {
	{ name = "Elder Bloodjaw", chance = 20, interval = 2000, max = 2 },
}
...
monster.loot = {
	{ id = 2160, chance = 8938, maxCount = 165 },
	{ id = 26029, chance = 11433, maxCount = 198 },
	{ id = 36316, chance = 10570, maxCount = 4 },
	{ id = 36317, chance = 10570, maxCount = 6 },
	{ id = 26030, chance = 11433, maxCount = 45 },
	{ id = 34281, chance = 10570, maxCount = 1 },
	{ id = 34283, chance = 10570, maxCount = 1 },
	{ id = 7440, chance = 10938, maxCount = 23 },
	{ id = 2156, chance = 10570, maxCount = 3 },
	{ id = 2153, chance = 10970, maxCount = 8 },
	{ id = 2154, chance = 10970, maxCount = 9 },
	{ id = 44084, chance = 360 },
}
...
monster.defenses = {
	...
	{ name = "speed", interval = 4000, chance = 80, effect = CONST_ME_MAGIC_RED, target = false, duration = 6000, speed = 700 },
}
