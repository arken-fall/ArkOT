...
monster.attacks = {
	...
	{ name = "speed", interval = 2000, chance = 15, radius = 1, effect = CONST_ME_MAGIC_RED, target = false, duration = 60000, speed = -400 },
}

monster.defenses = {
	defense = 30,
	armor = 30,
	{ name = "outfit", interval = 2000, chance = 10, effect = CONST_ME_GROUNDSHAKER, target = false, duration = 5000, monster = "bat" },
