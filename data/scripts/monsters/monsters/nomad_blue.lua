...
monster.bestiary = {
	...
	stars = 2,
	occurrence = 1,
	locations = "Ankrahmun Pharaoh Tombs, Deeper Drefia, Kha'zeel Mountains, Northern Darama Desert, Southern Darama Desert, Yalahar Foreigner Quarter, Yalahar Trade Quarter.",
}
