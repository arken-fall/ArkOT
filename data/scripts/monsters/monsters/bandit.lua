...
monster.bestiary = {
	...
	stars = 2,
	occurrence = 0,
	locations = "Dark Cathedral, Tiquanda Bandit Caves, Outlaw Camp, mountain pass west of Ankrahmun, Tyrsung, Thais Bandit Cave, Formorgar Mines. Also summoned by Gamel.",
}
