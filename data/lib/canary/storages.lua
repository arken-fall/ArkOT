-- Canary's own storage numbering, the names its npcs and quests read.
...
Storage.EmoteSpells = 30008

Storage.WagonTicket = 30009

Storage.FirstMageWeapon = 30011

Storage.ChayenneReward = 30033

Storage.Atrad = 30036

Storage.WayfarerOutfit = 30041

Storage.DreamOutfit = 30042

Storage.Percht1 = 30043

Storage.Percht2 = 30044

Storage.Percht3 = 30045

Storage.Irmana1 = 30046

Storage.Irmana2 = 30047

Storage.Navigator = 30048

Storage.DwarvenLegs = 30049

Storage.PrinceDrazzakTime = 30050
-- Reserved in Global.Storage.FamiliarSummonEvent10 = 30054
-- Reserved in Global.Storage.FamiliarSummonEvent60 = 30055

Storage.ChayenneKeyTime = 30056

Storage.FreeQuests = 30057

Storage.ShrineEntrance = 30060

Storage.PlayerWeaponReward = 30061
--[[
Old storages
Over time, this will be dropped and replaced by the table above
]]

Storage.DeeplingsWorldChange = {
...
Storage.TheHuntForTheSeaSerpent = {
	-- Reserved storage from 51410 - 51419
}

Storage.BanutaSecretTunnel = {
