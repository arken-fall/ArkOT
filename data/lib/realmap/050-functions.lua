...
-- the engine hands out reward chests natively (MonsterType:isRewardBoss); the
-- pack's Lua reward system is not loaded, so lever scripts that flag a summoned
-- boss keep working without it
