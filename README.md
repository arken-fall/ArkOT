...
Still to come: the wheel of destiny and the 12.x store protocol, which are stubbed off so the client is in-world without them; and a real-map datapack in BlackTek's Lua/TOML layout.
