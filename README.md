...
- **Prey (Phase D, honest empty)** — the prey widget gets three locked slots and prices at login and on request so the window opens cleanly; the prey system itself is next.
