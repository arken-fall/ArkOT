...
namespace BlackTek::Forge
{
	...
	class System
	{
		public:
			...
			[[nodiscard]] const TierPrice* getPrice(uint8_t classification, uint8_t tier) const noexcept;
		...
		private:
			...
			[[nodiscard]] uint32_t countCores(const PlayerPtr& player) const noexcept;
