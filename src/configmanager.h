...
public:
    ...
    enum BooleanConfig
    {
        ...
        REPLENISH_NOTIFICATION,
        REVIVE_NOTIFICATION,
        SMART_CONVERT_LEGACY_ZONES,
        STRIP_LEGACY_ZONE_FLAGS,
        SMART_CONVERT_LEGACY_SPAWNS,
        DISABLE_LEGACY_SPAWN_FILE_AFTER_CONVERSION,
    ...
    enum IntegerConfig
    {
        ...
        PLAYER_DEF_MODIFIER_CHARGES_CAP,
        PLAYER_ATK_MODIFIER_CHARGES_CAP,
        MONSTER_DEFENSE_CHARGES_CAP,
        MONSTER_ARMOR_CHARGES_CAP,
        DEFAULT_DEFENSE_CHARGE_COST,
        DEFAULT_ARMOR_CHARGE_COST,
        DEFAULT_DEF_MODIFIER_CHARGE_COST,
        DEFAULT_ATK_MODIFIER_CHARGE_COST,
        HEAL_EFFECT,
        RESTORE_EFFECT,
        REPLENISH_EFFECT,
        REVIVE_EFFECT,
